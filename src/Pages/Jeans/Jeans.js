...
import "./Jeans.css"; // On peut réutiliser le même CSS que Tshirts
...
const Jeans = () => {
  ...
  const jeans = listProducts.filter(
    (product) => product.category?.toLowerCase() === "jeans"
  );
  ...
  return (
    <div className="jeans-page">
      <h2 className="jeans-title">Jeans</h2>
